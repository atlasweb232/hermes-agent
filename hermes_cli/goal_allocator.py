...
def _capture_worker_attempt_runtime_failure(
    ...
    try:
        ...
        capture_delegated_worker_runtime_failure(
            ...
            requested_route=plan.primary_worker if attempt.worker_id == plan.primary_worker else attempt.worker_id,
            actual_route=attempt.route,
            worker_family=attempt.worker_id,
            latency_seconds=attempt.duration_seconds,
            evidence_refs=attempt.artifact_refs,
            allocation_refs=[f"hermes:allocation:{attempt.allocation_id}:{attempt.attempt_id}"],
